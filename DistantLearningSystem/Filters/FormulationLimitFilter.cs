// --------------------------------------------------------------------------------------------------------------------
// <copyright file="FormulationLimitFilter.cs" company="NURE">
//   BD
// </copyright>
// <summary>
...
namespace DistantLearningSystem.Filters
{
    ...
    /// </summary>
    public class FormulationLimitFilter : ActionFilterAttribute
    {
        /// <summary>
        /// Not implemented.
        /// </summary>
        ...
        public override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            ...
            if (DataManager.Student.CanAddFormulation(studentId))
            {
                return;
            }
